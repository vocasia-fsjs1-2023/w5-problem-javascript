...
var secondWord4Lenght = secondWord4.length;
...
console.log(
  "Second Word: " + secondWord4 + ", with length: " + secondWord4Lenght
);
console.log("Third Word: " + thirdWord4 + ", with length: " + thirdWord4Lenght);
console.log(
  "Fourth Word: " + fourthWord4 + ", with length: " + fourthWord4Lenght
);
